...
if (isset($_GET['delete_id'])) {
    ...
    $sql_delete = "DELETE FROM orderdetails WHERE order_id =$order_id";
            ...
            <div class="table-responsive">
                <table class="display table table-bordered" id="example" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        $sql = "select order_id, order_date,users.user_name, order_name, order_price, order_quantity, order_total from orderdetails, users where orderdetails.user_id=users.user_id and order_status='Ordered' order by order_date desc";
